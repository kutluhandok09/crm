    ...
    */
    ...
    'connections' => [
        ...
        'central' => [
            ...
            'database' => env('DB_CENTRAL_DATABASE', env('DB_DATABASE', 'erp_central')),
            ...
            'charset' => env('DB_CENTRAL_CHARSET', env('DB_CHARSET', 'utf8mb4')),
        ...
        'tenant' => [
            ...
            'username' => env('DB_TENANT_USERNAME', env('DB_CENTRAL_USERNAME', env('DB_USERNAME', 'root'))),
            'password' => env('DB_TENANT_PASSWORD', env('DB_CENTRAL_PASSWORD', env('DB_PASSWORD', ''))),
            'unix_socket' => env('DB_TENANT_SOCKET', env('DB_CENTRAL_SOCKET', env('DB_SOCKET', ''))),
            'charset' => env('DB_TENANT_CHARSET', env('DB_CENTRAL_CHARSET', env('DB_CHARSET', 'utf8mb4'))),
